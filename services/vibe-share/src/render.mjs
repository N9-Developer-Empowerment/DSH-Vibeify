...
const MEDIA_CSS = `.media-card{margin:34px 0;padding:clamp(18px,4vw,28px);overflow:hidden;border:1px solid #ffffff20;border-radius:18px;background:linear-gradient(120deg,#32182d,#121526)}.media-actions{display:flex;align-items:center;gap:14px;margin-top:12px}.media-actions a{color:#ffc0d4;font-size:13px;text-underline-offset:3px}.media-frame:not(:empty){margin-top:20px}.media-frame iframe{width:100%;height:clamp(240px,48vw,520px);display:block;border:0;border-radius:14px;background:#080609}.media-card[data-media-kind="music"] .media-frame iframe{height:352px}.media-card[data-media-provider="soundcloud"] .media-frame iframe{height:166px;background:#fff}@media(max-width:680px){.media-actions{align-items:stretch;flex-direction:column}.media-actions button{width:100%}.media-frame iframe{height:240px}.media-card[data-media-provider="soundcloud"] .media-frame iframe{height:166px}}`;
